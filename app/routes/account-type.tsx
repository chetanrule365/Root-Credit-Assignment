  ...
  return (
    <Layout>
      <motion.section
        ...
        className="flex h-full w-full flex-col justify-between rounded-4xl bg-white p-8 shadow-[0_30px_80px_-30px_rgba(15,23,42,0.32)] md:w-1/2"
      >
        <div>
            ...
            {accountTypes.map((accountType) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setValue("accountType", accountType.id, {
                      shouldValidate: true,
                    })
                  }
                ...
                >
                  ...
                  <span
                    className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border text-base font-semibold ${
                      selected
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <button
            ...
            className="inline-flex h-12 items-center justify-center rounded-full bg-blue-600 px-6 text-sm font-semibold text-white transition duration-200 hover:bg-blue-500 disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-500"
